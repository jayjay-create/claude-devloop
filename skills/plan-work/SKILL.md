...
Then offer to cut it into tasks and do that on a yes. Say what that means in
plain words: single pieces of work, each one demonstrable on its own, in an order.
